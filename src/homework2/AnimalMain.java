...
public class AnimalMain {
    ...
    public static void main(String... args) {
        ...
        do {
            ...
            consoleCommand = scanner.next().trim().toLowerCase();
            if (!menuNames.contains(consoleCommand)) {
                ...
                if (menuCommand.equals(MenuData.ADD)) {
                    ...
                    consoleAge = getAnimalWeightAge("Введите возраст животного в годах:",
                            "Возраст должен быть положительным целым числом!");

                    consoleWeight = getAnimalWeightAge("Введите вес животного в кг.:",
